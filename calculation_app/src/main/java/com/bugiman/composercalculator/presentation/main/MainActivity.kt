    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModelCalculation: CalculatorViewModel by viewModels {
            CalculationViewModelFactory(
                ...
                buildDigitCursorUseCase = app.buildDigitCursorUseCase,
                ...
                buildBracketLeftCursorUseCase = app.buildBracketLeftCursorUseCase,
                buildBracketRigthUseCase = app.buildBracketRigthUseCase,
                buildDecimalUseCase = app.buildDecimalUseCase,
                buildDecimalCursorUseCase = app.buildDecimalCursorUseCase,
                buildZeroUseCase = app.buildZeroUseCase,
                buildCommaUseCase = app.buildCommaUseCase,
                buildOperatorCursorUseCase = app.buildOperatorCursorUseCase,
                removeLastCharUseCase = app.removeLastCharUseCase,
                removeAtCursorUseCase = app.removeAtCursorUseCase,
                removeBeforeCursorUseCase = app.removeBeforeCursorUseCase,
